...
class Spacious_Theme_Review_Notice {
	...
	public function __construct() {
		...
		add_action( 'admin_enqueue_scripts', array( $this, 'spacious_theme_rating_notice_enqueue' ) );
	...
	public function spacious_theme_review_notice() {
		 ...
		 */
		if ( ( get_option( 'spacious_theme_installed_time' ) > strtotime( '-1 month' ) ) || ( $ignored_notice_partially > strtotime( '-1 month' ) ) || ( $ignored_notice ) ) {
			return;
		}
		?>
		...
		<div class="notice updated theme-review-notice" style="position:relative;">
			...
			<a class="notice-dismiss" style="text-decoration:none;" href="?nag_spacious_ignore_theme_review_notice_partially=0"></a>
		</div>
	 ...
	 */
	public function spacious_theme_rating_notice_enqueue() {

		wp_enqueue_style( 'spacious-theme-review-notice', get_template_directory_uri() . '/css/admin/theme-review-notice.css' );
