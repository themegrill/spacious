...
/**
 * Spacious_Demo_Importer Class.
 */
class Spacious_Demo_Importer {
	...
	public function __construct() {
		$this->plugin_data = array(
			...
			'name' => __( 'ThemeGrill Demo importer', 'spacious' ),
		);
	...
	public function add_admin_menu() {
		add_theme_page( __( 'Demo Importer', 'spacious' ), __( 'Demo Importer', 'spacious' ), 'switch_themes', 'demo-importer', array( $this, 'demo_importer' ) );
	}
