 ...
 *
 * Class Spacious_Buttonset_Control
 */
class Spacious_Buttonset_Control extends Spacious_Customize_Base_Additional_Control {
	 ...
	 * @var string
	 */
	public $type = 'spacious-buttonset';
	...
	protected function content_template() {
		...
		<div id="input_{{ data.id }}" class="buttonset">
			...
			<div class="buttonset-inner">
				...
				<label for="{{ data.id }}{{ key }}" class="spacious-buttonset">
					{{{ data.choices[ key ] }}}
				</label>
			</div>
			<# } #>
