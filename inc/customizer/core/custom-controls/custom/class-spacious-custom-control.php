 ...
 * Class Spacious_Custom_Control
 */
class Spacious_Custom_Control extends Spacious_Customize_Base_Additional_Control {
	...
	protected function content_template() {
		...
		<# if ( data.info ) { #>
		<div class="spacious-custom-info">
			{{{ data.info }}}
		</div>
		<# } #>

		<# if ( data.links ) { #>
		<ul class="spacious-custom-links">
