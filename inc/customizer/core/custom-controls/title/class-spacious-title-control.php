 ...
 * Class Spacious_Title_Control
 */
class Spacious_Title_Control extends Spacious_Customize_Base_Additional_Control {
	...
	protected function content_template() {
        ...
        <div class="spacious-title-wrapper">
