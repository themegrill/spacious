...
if ( class_exists( 'WP_Customize_Section' ) ) {
	...
	/**
	 * Class Spacious_Customize_Upsell_Section
	 */
	class Spacious_Customize_Upsell_Section extends WP_Customize_Section {
		 ...
		 * @var string
		 */
		public $type = 'spacious_customize_upsell_section';
