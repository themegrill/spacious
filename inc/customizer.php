...
function spacious_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting( 'spacious[spacious_related_posts_activate]', array(
		'default'           => 0,
		'type'              => 'option',
		'capability'        => 'edit_theme_options',
		'sanitize_callback' => 'spacious_checkbox_sanitize',
	...
	$wp_customize->add_control( 'spacious[spacious_related_posts_activate]', array(
		'type'     => 'checkbox',
	...
	$wp_customize->add_setting( 'spacious[spacious_related_posts]', array(
		'default'           => 'categories',
		'type'              => 'option',
		'capability'        => 'edit_theme_options',
	...
	$wp_customize->add_control( 'spacious[spacious_related_posts]', array(
		'type'     => 'radio',
